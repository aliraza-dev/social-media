...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({
  ...
  const statusText = useMemo(() => {
    if (data.isGroup) {
      return `${data.users.length} active`;
    }
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                <Transition.Child
                  as={Fragment}
                  enter="transform east-in-out transition duration-500"
                  enterFrom="translate-x-full"
                  enterTo="translate-x-0"
                  leave="transform transition ease-in-out duration-600"
                      ...
                      >
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 y-8">
                            ...
                            >
                              <div className="w-10 h-10 bg-neutral-100 rounded-full justify-center flex items-center">
                                <IoTrash size={20} />
                              </div>
